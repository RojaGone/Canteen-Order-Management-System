...
namespace Core.Controllers
{
    public class FeedbackMastersController : Controller
    {
        ...
        {
            return Redirect("http://localhost:9979/FeedbackMasters/test1");
        }
        ...
        {
            return Redirect("http://localhost:56716/Home/Homeindex");
        }
        public async Task<IActionResult> Show1()
        {
            return Redirect("http://localhost:56716/Admin");
        }
        public async Task<IActionResult> AdminShow()
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.UserMaster, "UserId", "Address", feedbackMaster.UserId);
            return View(feedbackMaster);
        }
